...
void main() {
  ...
  writeWav('assets/sounds/classic.wav', renderPattern([
    for (var i = 0; i < 4; i++) ...[
      Tone(880, 0.18),
      Silence(0.08),
      Tone(880, 0.18),
  ...
  writeWav('assets/sounds/sunrise.wav', renderPattern([
  ...
  writeWav('assets/sounds/pulse.wav', renderPattern([
    for (var i = 0; i < 6; i++) ...[
...
List<int> renderPattern(List<Segment> segments) {
  ...
  for (final segment in segments) {
    ...
    for (var i = 0; i < count; i++) {
      ...
      samples.add((math.sin(2 * math.pi * tone.freq * t) * amp * 32767).round());
    }
  }
  return samples;
}
